...
import {
  deleteMostRecentAceEndicoAppSuggestionRow,
  readAceEndicoSuggestionInspectorRows,
  toggleAceEndicoSuggestionRowExcluded,
...
import { readAceEndicoDisplayedHistory } from './aceEndicoOrderHistoryStorage'
...
import { AceEndicoOrderSheet } from './AceEndicoOrderSheet'
...
export function AceEndicoVendorWorkspace({ onBack }: Props) {
  ...
  const historyRows = useMemo(() => {
    void dataTick
    return readAceEndicoDisplayedHistory(aceEndicoCatalogItems)
  }, [dataTick])

  const suggestionInspectorRows = useMemo(() => {
    void dataTick
    void inspectorTick
    return readAceEndicoSuggestionInspectorRows(aceEndicoCatalogItems)
              ...
              <div className="rounded-md border border-stone-300 bg-[#faf8f5] px-4 py-4 shadow-inner">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2 mt-1 flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          setSettingsDraft(
                            resolveVendorPlatformConfig(aceEndicoPlatformConfig).settings,
                          )
                          setIsEditingSettings(false)
                        }}
                      >
                ...
                <SuggestionHistoryInspector
                  ...
                  onToggleInclude={(rowId) => {
                    toggleAceEndicoSuggestionRowExcluded(rowId)
